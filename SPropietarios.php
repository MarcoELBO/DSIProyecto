...
<head>
    ...
    <title>Resultados de Propietarios</title>
...
<body>
    ...
    <main class="page-wrapper">
        <section class="data-card">
            <h1 class="data-card__title">Resultados de la Búsqueda de Propietarios</h1>
            ...
            <?php else: ?>
                <p class="data-card__empty-message">No se encontraron propietarios con el criterio especificado.</p>
            <?php endif; ?>
