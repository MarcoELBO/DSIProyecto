...
<head>
    ...
    <title>Solicitar PDF de Licencia</title>
    <link rel="stylesheet" href="./css/FACCESO.css">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/sweetalert2@11/dist/sweetalert2.min.css">
</head>
<body>
    <div class="page-container">
        <h1 class="page-title">Solicitar PDF de Recaudanet</h1>

        <form class="form form--pdf-request js-form-submit" action="VRecaudanet.php" method="post">
            <div class="form__group">
                <label for="id" class="form__label">ID Recaudanet:</label>
                <input type="text" id="id" name="id" class="form__input" required>
            </div>

            <div class="form__group form__group--actions">
                <input type="submit" class="button button--primary form__button" value="Generar PDF">
            </div>
        </form>
    </div>
                    ...
                    if (response.ok) { // response.ok es true para códigos 2xx
                        ...
                        if (response.status === 400) {
                            Swal.fire({
                                ...
                                text: 'Error al solicitar el PDF: ' + (errorData.message || 'Verifique el ID de licencia.'),
                                confirmButtonText: 'Aceptar'
                            });
                             ...
                             Swal.fire({
                                ...
                                text: errorData.message || 'No se encontró una licencia con el ID proporcionado.',
                                confirmButtonText: 'Aceptar'
                            });
                            ...
                            Swal.fire({
                                ...
                                text: 'Fallo en el servidor al generar el PDF: ' + (errorData.message || 'Intente de nuevo más tarde.'),
                                confirmButtonText: 'Aceptar'
                            });
                        } else {
                            Swal.fire({
