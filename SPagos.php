...
<body>
    ...
    <main class="page-wrapper">
        <section class="data-card">
            <h1 class="data-card__title">Resultados de la Búsqueda de Pagos</h1>
            ...
            <?php else: ?>
                <p class="data-card__empty-message">No se encontraron pagos con el criterio especificado.</p>
            <?php endif; ?>
