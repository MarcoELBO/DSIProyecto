...
<head>
    ...
    <title>Resultados de Multas</title>
...
<body>
    ...
    $sql = "SELECT * FROM multas WHERE $atributo LIKE '$criterio';"; // Agregado '%' para búsqueda parcial
    ...
    <main class="page-wrapper">
        <section class="data-card">
            <h1 class="data-card__title">Resultados de la Búsqueda de Multas</h1>
            ...
            <?php else: ?>
                <p class="data-card__empty-message">No se encontraron multas con el criterio especificado.</p>
            <?php endif; ?>
