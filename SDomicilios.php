...
<head>
    ...
    <title>Resultados de Domicilios</title>
    <link rel="stylesheet" href="./css/FACCESO.css">
    </head>
<body>
    <?php
    // Obtener los valores del front end
    ...
    $sql = "SELECT * FROM domicilios WHERE $atributo LIKE '$criterio';"; // Agregado '%' para búsqueda parcial
    ...
    <main class="page-wrapper">
        <section class="data-card">
            <h1 class="data-card__title">Resultados de la Búsqueda de Domicilios</h1>
            ...
            <?php else: ?>
                <p class="data-card__empty-message">No se encontraron domicilios con el criterio especificado.</p>
            <?php endif; ?>
