...
<body>
    <main class="page-wrapper">
        <section class="form-card">
            <h1 class="form-card__title">Eliminar Licencia</h1>
            <form action="DLicencias.php" method="get" class="form">
                <div class="form__group">
                    <label for="NO_LICENCIA" class="form__label">No. Licencia:</label>
                    <input type="text" id="NO_LICENCIA" name="NO_LICENCIA" required class="form__input">
                </div>
