...
<body>
    <main class="page-wrapper">
        <section class="form-card">
            <h1 class="form-card__title">Eliminar Multa</h1>
            <form action="DMultas.php" method="get" class="form">
                <div class="form__group">
                    <label for="Folio" class="form__label">Folio:</label>
                    <input type="text" id="Folio" name="Folio" required class="form__input">
                </div>
