...
<head>
    ...
    <title>Eliminar Tarjeta de Verificación</title>
    <link rel="stylesheet" href="./css/FACCESO.css">
</head>
<body>
    <main class="page-wrapper">
        <section class="form-card">
            <h1 class="form-card__title">Eliminar Tarjeta de Verificación</h1>
            <form action="DTarjetasVerificacion.php" method="get" class="form">
