...
<head>
    ...
    <title>Resultados de Tarjetas de Verificación</title>
...
<body>
    ...
    $sql = "SELECT * FROM tarjetas_verificacion WHERE $atributo LIKE '$criterio';"; // Agregado '%' para búsqueda parcial
    ...
    <main class="page-wrapper">
        <section class="data-card">
            <h1 class="data-card__title">Resultados de la Búsqueda de Tarjetas de Verificación</h1>
            ...
            <?php else: ?>
                <p class="data-card__empty-message">No se encontraron tarjetas de verificación con el criterio especificado.</p>
            <?php endif; ?>
