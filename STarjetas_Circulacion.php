...
<head>
    ...
    <title>Resultados de Tarjetas de Circulación</title>
...
<body>
    ...
    $sql = "SELECT * FROM tarjetas_circulacion WHERE $atributo LIKE '$criterio';"; // Agregado '%' para búsqueda parcial
    ...
    <main class="page-wrapper">
        <section class="data-card">
            <h1 class="data-card__title">Resultados de la Búsqueda de Tarjetas de Circulación</h1>
            ...
            <?php else: ?>
                <p class="data-card__empty-message">No se encontraron tarjetas de circulación con el criterio especificado.</p>
            <?php endif; ?>
