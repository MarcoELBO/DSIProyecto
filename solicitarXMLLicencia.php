...
<head>
    ...
    <title>Solicitar XML de Licencia</title>
    <link rel="stylesheet" href="./css/FACCESO.css">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/sweetalert2@11/dist/sweetalert2.min.css">
</head>
<body>
    <div class="page-container">
        <h1 class="page-title">Solicitar XML de Licencia</h1>

        <form class="form form--pdf-request js-form-submit" action="XMLicencia.php" method="post">
                    ...
                    if (response.ok) { // response.ok es true para códigos 2xx
                        ...
                        if (response.status === 400) {
                            Swal.fire({
                                ...
                                text: 'Error al solicitar el XML: ' + (errorData.message || 'Verifique el ID de licencia.'),
                                confirmButtonText: 'Aceptar'
                            });
