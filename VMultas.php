...
$pdf->SetFont('Arial', '', 10);
$pdf->Cell(95, 8, 'Fecha: ' . $Datos[1], 1);
$pdf->Cell(65, 8, 'Hora: ' . $Datos[2], 1, 1);

// Lugar
$pdf->MultiCell(0, 8, "Lugar de la infraccion: " . $Datos[3], 1);
$pdf->Ln(2);
...
$pdf->SetFont('Arial', '', 10);
$pdf->Cell(95, 8, 'Nombre: ' . $Datos[4], 1);
$pdf->Cell(65, 8, 'Licencia: ' . $Datos[5], 1, 1);
$pdf->Cell(0, 8, 'Direccion: ' . $Datos[6], 1, 1);
$pdf->Ln(2);
...
$pdf->SetFont('Arial', '', 10);
$pdf->Cell(95, 8, 'Nombre: ' . $Datos[12], 1);
$pdf->Cell(65, 8, 'Placa: ' . $Datos[13], 1, 1);
$pdf->Ln(2);
...
$pdf->SetFont('Arial', '', 10);
$pdf->MultiCell(0, 8, 'Recaudanet', 1);
$pdf->Ln(2);
