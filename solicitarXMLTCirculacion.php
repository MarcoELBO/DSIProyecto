...
<head>
    ...
    <title>Solicitar XML de Circulación</title>
    <link rel="stylesheet" href="./css/FACCESO.css">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/sweetalert2@11/dist/sweetalert2.min.css">
</head>
<body>
    <div class="page-container">
        <h1 class="page-title">Solicitar XML de Circulación</h1>

        <form class="form form--pdf-request js-form-submit" action="XMLTCirculacion.php" method="post">
            <div class="form__group">
                <label for="id" class="form__label">ID de Circulación:</label>
