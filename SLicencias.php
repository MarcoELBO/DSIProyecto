...
<head>
    ...
    <title>Resultados de Licencias</title>
...
<body>
    ...
    $sql = "SELECT * FROM licencias WHERE $atributo LIKE '%$criterio%';"; // Agregado '%' para búsqueda parcial
    ...
    <main class="page-wrapper">
        <section class="data-card">
            <h1 class="data-card__title">Resultados de la Búsqueda de Licencias</h1>
            ...
            <?php else: ?>
                <p class="data-card__empty-message">No se encontraron licencias con el criterio especificado.</p>
            <?php endif; ?>
